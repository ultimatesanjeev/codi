                                       ...
                                       &nbsp;&nbsp; <?=$this->session->flashdata('not_del_data');?> </div>
                                        <?php }?>   
                                                                ...
                                                                <div class="caption font-dark">
                                                                    <i class="font-dark"></i>
                                                                    <span class="caption-subject bold uppercase"> Manage Color Book Category</span>
                                                                </div>
                                                                <!--<div class="actions">
                                                            ...
                                                            <div class="portlet-body">
                                                                <div class="table-toolbar">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="btn-group">
                         		 <?php echo anchor('admin/masters/addcolorbookcat','Add New<i class="fa fa-plus"></i> ',array('class'=>'btn sbold green','id'=>'sample_editable_1_new'));?>
																	...
																	<?php
                                                                     ...
                                                                     if (isset($record) && !empty($record)){
                                                                        ...
                                                                        <tr class="odd gradeX">                                                                           
                                                                            ...
                                                                            <td> <?=$row->catName;?> </td>
                                                                            <td> <img src="<?php echo TIMTHUMB;?>src=<?=UPLOADCOLORBOOKCAT.$row->image;?>&w=80&h=80&zc=1&f=0|0|0|0|0"> </td>                                                                          
                                                                           <?php /*?> <td> <?=$row->borderColor;?> </td><?php */?>
                                                                            <td> <?=$row->sortOrder;?> </td>
                                                                            <td>                                                                         
                                                                            <?php echo anchor('admin/masters/editcolorbookcat/'.$row->mccID,'Edit <i class="fa fa-edit"></i> ',array('class'=>'btn blue','id'=>'sample_editable_1_new'));?>
                                                                       
                                                                             
                                                                   <?php echo anchor('admin/masters/deletecolorbookcat/'.$row->mccID,'Delete <i class="fa fa-remove"></i> ',array('class'=>'btn red','id'=>'sample_editable_1_new','onclick'=>"return confirm('Are you sure you want to Delete the record ?')"));?>
